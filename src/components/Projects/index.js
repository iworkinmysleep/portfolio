		...
		<ProjectsContainer id="projects">
			...
			<ProjectsWrapper>
				<ProjectsCard>
					...
					<ProjectsP>
						Full stack eCommerce app built with MERN stack. User auth using JWT.
						Admin users have crud functionality with products and users.{" "}
					</ProjectsP>
					<LinksContainer>
						<ProjectLink
							target="blank"
				...
				<ProjectsCard>
					...
					<ProjectsP>
						I built this small app to help solve a problem for a telecom company
						that needed to keep inventory notes. React, Node, Express, MongoDB.
					</ProjectsP>
					<LinksContainer>
						<ProjectLink
							target="blank"
